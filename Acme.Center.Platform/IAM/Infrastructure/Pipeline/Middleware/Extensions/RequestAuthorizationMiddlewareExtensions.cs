using Acme.Center.Platform.IAM.Infrastructure.Pipeline.Middleware.Components;

namespace Acme.Center.Platform.IAM.Infrastructure.Pipeline.Middleware.Extensions;
