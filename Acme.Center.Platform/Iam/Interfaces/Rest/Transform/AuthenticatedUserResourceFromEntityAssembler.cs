...
/// <summary>
///     Assembler responsible for transforming a <see cref="User"/> aggregate and a JWT token into an <see cref="AuthenticatedUserResource"/>.
/// </summary>
public static class AuthenticatedUserResourceFromEntityAssembler
{
    ...
    /// </returns>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="user"/> is null or <paramref name="token"/> is null.</exception>
        ...
        User user, string token)
    {
        ...
        {
            throw new ArgumentException("Token cannot be null or empty when creating authenticated user resource.", nameof(token));
        }
