...
/// <summary>
///     Assembler responsible for transforming a <see cref="CreateCategoryResource"/> into a <see cref="CreateCategoryCommand"/>.
/// </summary>
public static class CreateCategoryCommandFromResourceAssembler
{
    ...
    public static CreateCategoryCommand ToCommandFromResource(CreateCategoryResource resource)
    {
        if (resource == null)
        {
            throw new ArgumentNullException(nameof(resource), "CreateCategoryResource cannot be null when converting to command.");
        }
