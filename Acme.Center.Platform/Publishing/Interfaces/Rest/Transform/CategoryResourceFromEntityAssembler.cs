...
/// <summary>
///     Assembler responsible for transforming a <see cref="Category"/> domain entity into a <see cref="CategoryResource"/> for REST representation.
/// </summary>
public static class CategoryResourceFromEntityAssembler
{
    ...
    public static CategoryResource ToResourceFromEntity(Category entity)
    {
        if (entity == null)
        {
            throw new ArgumentNullException(nameof(entity), "Category entity cannot be null when converting to resource.");
        }
