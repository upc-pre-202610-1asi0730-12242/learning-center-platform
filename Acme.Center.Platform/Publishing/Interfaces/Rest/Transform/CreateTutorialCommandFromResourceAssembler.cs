...
/// <summary>
///     Assembler responsible for transforming a <see cref="CreateTutorialResource"/> into a <see cref="CreateTutorialCommand"/>.
/// </summary>
public static class CreateTutorialCommandFromResourceAssembler
{
    ...
    public static CreateTutorialCommand ToCommandFromResource(CreateTutorialResource resource)
    {
        if (resource == null)
        {
            throw new ArgumentNullException(nameof(resource), "CreateTutorialResource cannot be null when converting to command.");
        }
